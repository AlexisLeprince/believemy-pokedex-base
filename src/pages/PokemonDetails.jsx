...
export default function PokemonDetails() {
  ...
  const {
    ...
    isNaN(id)
      ? `https://believemy-pokedex-c9a7b-default-rtdb.europe-west1.firebasedatabase.app/pokemons/${id}.json`
  ...
  //   if (isNaN(id)) {
  //     url = `https://believemy-pokedex-c9a7b-default-rtdb.europe-west1.firebasedatabase.app/pokemons/${id}.json`;
  //   }
  ...
  //   } catch (error) {
  //     setLoading(false);
  //     toast.error("Erreur de chargement du pokemon");
  //   }
  // };
